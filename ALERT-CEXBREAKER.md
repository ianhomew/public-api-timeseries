...
## 🔴 cex_events／mexc 上下架規模異常熔斷警報（2026-09-15）

<!-- cex_events:mexc:2026-09-15 -->

檢查時間（UTC）：2026-09-15T03:30:25+00:00
...
| 前日筆數 | 2006 |
| 當日 DELISTED 筆數 | 30（1.50%） |
| 熔斷門檻（筆數） | 20.1＝max(10, 1.0%×前日筆數) |
| 同組 LISTED／STATUS_CHANGED | 3／0 |
| 分頁截斷指紋 tail_cover | 0.0000（參考值，門檻 0.50；本來源不用它否決，見 BREAKER_TRUNCATION_QUARANTINE） |
| 處置 | **標記但不否決**：事件已寫入 `track-crypto/data/cex_events/events.jsonl` |
